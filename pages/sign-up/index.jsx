...
const SignUp = () => {
  ...
  return (
    <div className='h-screen flex justify-center px-4 items-center'>
      <div
        className='flex flex-col gap-5  sm:w-[25rem] w-full rounded-[1rem]'
        style={{
      ...
      >
        <div className='flex flex-col items-center justify-center'>
          ...
          <span className='text-[#000000a6] text-center text-[1rem] font-[400]'>
            to continue to AI business reports
          </span>
        </div>
        ...
        <div className='grid grid-cols-2 self-center gap-5'>
          <div
            ...
            className='p-4 border flex items-center cursor-pointer hover:bg-gray-100 justify-center bg-white  rounded-xl w-[80px] min-w-[80px]'
          >
            <img src='/images/google.svg' alt='logo' className='w-fit' />
          </div>
          <div
            onClick={handleFacebookSignin}
            className='p-4 flex items-center cursor-pointer hover:bg-gray-100 border bg-white justify-center  rounded-xl w-[80px] min-w-[80px]'
          >
        ...
        <div className='flex flex-col'>
          ...
          <input
            ...
            name='email'
            id='email'
            className='py-[0.625rem] px-[1rem] w-full rounded-[0.375rem] border outline-none border-[#00000029]'
          />
        </div>
        ...
        <button
          ...
          className='bg-[#103FEF] hover:bg-[#0D33BF] min-h-[2.25rem] rounded-[0.375rem] text-white font-[600]'
          style={{ fontSize: '12px' }}
        >
          CONTINUE
        </button>
